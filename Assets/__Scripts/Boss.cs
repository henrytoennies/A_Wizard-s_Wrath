...
public class Boss : MonoBehaviour
{
    ...
    void ElemSelect()
    {
        ...
        switch (Random.Range(1,4))
        {
            case 1:
                ...
                if (attackID == 0)
                    attackID = -1;
                transform.position = new Vector3(18,attackID * 6,0);
    ...
    void GrassAttack()
    {
        ...
        {
            case 1:
                Vector3 attackPos = attackPoints[Random.Range(0,4)];
                
                float deltaX = transform.position.x - attackPos.x;
                float deltaY = transform.position.y - attackPos.y;
                float rotY = 180f / 3.14159f * Mathf.Atan2(deltaY, deltaX);

                print(attackPos.x.ToString() + " " + attackPos.y.ToString() + " " + attackPos.z.ToString());
                ...
                bomb.rigid.velocity = Quaternion.Euler(0,0,rotY) * Vector3.left * def.velocity * 0.5f;
